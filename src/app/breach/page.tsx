...
import {  generateH8 } from "@/reports";
...
export default function Page() {
  ...
  useEffect(() => {
    const reportString = localStorage.getItem("h8");
  ...
  const generatePDF = async (report: any) => {
    try {
      const url = await generateH8(report, "Incumplimientos");

      const fileName = "incumplimientos.pdf";
