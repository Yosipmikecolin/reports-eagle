...
import { generateH13 } from "@/reports";
...
export default function Page() {
  ...
  useEffect(() => {
    const reportString = localStorage.getItem("h13");
  ...
  const generatePDF = async (report: any) => {
    try {
      const url = await generateH13(report, "Proximas Instalaciones");

      const fileName = "proximas_instalaciones.pdf";
