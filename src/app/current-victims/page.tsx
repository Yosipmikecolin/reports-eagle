...
import { generateH17 } from "@/reports";
...
export default function Page() {
  ...
  useEffect(() => {
    const reportString = localStorage.getItem("h17");
  ...
  const generatePDF = async (report: any) => {
    try {
      const url = await generateH17(report, "Víctimas en estado de vigencia en el sistema");

      const fileName = "víctimas_vigencia.pdf";
