...
import { generateH14 } from "@/reports";
...
export default function Page() {
  ...
  useEffect(() => {
    const reportString = localStorage.getItem("h14");
  ...
  const generatePDF = async (report: any) => {
    try {
      const url = await generateH14(report, "Proximas desinstalaciones");

      const fileName = "proximas_desinstalaciones.pdf";
