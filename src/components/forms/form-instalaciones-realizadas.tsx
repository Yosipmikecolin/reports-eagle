...
export default function FormDatosJudiciales() {
  ...
  const handleGenerateReport = () => {
    localStorage.setItem("h12", JSON.stringify(formDataList));
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { id: "fechaActivacion", label: "Fecha Activación" },
              { id: "fechaInstalacion", label: "Fecha Instalación" },
              { id: "clm", label: "CLM" },
              ...
              <div className="space-y-2" key={id}>
                ...
                <Input
                  ...
                  type={
                    ["fechaActivacion", "fechaInstalacion"].includes(id)
                      ? "datetime-local"
                      : "text"
                  }
                  readOnly={[
