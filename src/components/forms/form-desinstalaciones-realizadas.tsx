...
export default function FormDatosJudiciales() {
  ...
  const handleGenerateReport = () => {
    localStorage.setItem("h11", JSON.stringify(formDataList));
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { id: "fechaDesactivacion", label: "Fecha de desactivación" },
              { id: "fechaDesinstalacion", label: "Fecha de desisntalación" },
              { id: "motivoDesinstalacion", label: "Motivo de desinstalación" },
              { id: "clm", label: "CLM" },
              { id: "tecnicoEmpresa", label: "Técnico de la empresa" },
            ].map(({ id, label }) => (
              <div className="space-y-2" key={id}>
                ...
                <Input
                  ...
                  type={
                    ["fechaDesactivacion", "fechaDesinstalacion"].includes(id)
                      ? "datetime-local"
                      : "text"
                  }
                  readOnly={[
