...
export default function FormDatosJudiciales() {
  ...
  const handleGenerateReport = () => {
    localStorage.setItem("h8", JSON.stringify(formDataList));
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { id: "crs", label: "CRS" },
              { id: "nDispositivo", label: "N de dispositivos" },
              { id: "tipoIncumplimiento", label: "Tipo de incumplimiento" },
              { id: "fechaHoraAlarma", label: "Fecha y hora de la alarma" },
              {
