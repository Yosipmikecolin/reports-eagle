...
export default function FormActivacionDesactivacion() {
  ...
  const [carrier, setCarrier] = useState<any>(); // Estado para el portador seleccionado
  ...
  const handleGenerateReport = () => {
    localStorage.setItem("h2", JSON.stringify(formDataList));
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { id: "fechaActivacion", label: "Fecha de activacion" },
              { id: "fechaDesactivacion", label: "Fecha de desactivación" },
              { id: "motivoDesactivacion", label: "Motivo desactivacion" },
