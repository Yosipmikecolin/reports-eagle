...
export default function FormProximasDesinstalaciones() {
  ...
  const handleGenerateReport = () => {
    saveReport("Próximas Desinstalaciones", formData);
    localStorage.setItem("h14", JSON.stringify(formData));
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="fechaHoraDesinstalacion">
            Fecha y hora desinstalación programada
          </Label>
          <Input
            id="fechaHoraDesinstalacion"
            type="datetime-local"
            value={formData.fechaHoraDesinstalacion}
            onChange={handleInputChange}
          />
        </div>
      </CardContent>
