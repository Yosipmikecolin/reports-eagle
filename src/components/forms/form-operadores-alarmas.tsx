...
/*   const handlePortadorChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
  ...
  const handleGenerateReport = () => {
    localStorage.setItem("h18", JSON.stringify(formDataList));
  ...
  return (
   ...
   {/*        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              { id: "nombreOperador", label: "Nombre operador" },
              { id: "tipoAlarma", label: "Tipo de alarma" },
              { id: "fechaHora", label: "Fecha y hora" },
              ...
              <div className="space-y-2" key={id}>
                ...
                <Input
                  ...
                  type={["fechaHora"].includes(id) ? "datetime-local" : "text"}
                  readOnly={[
                    "folio",
                    "nombre",
                    "run",
